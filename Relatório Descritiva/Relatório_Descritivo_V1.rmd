...
4. `commit.sh`: acessa a pasta `cronjob` e executa os 3 scripts acima, após isso, adiciona ao [**Covid19BR**](https://github.com/sjlva/Covid19BR) os arquivos atualizados.    
