...
leaflet(data = est) %>%
  ...
  addLegend(position = "bottomright", pal = redsNA, values = ~obitos_100k, 
            title="Óbitos (por 100 mil<br>habitantes)", na.label = "", opacity = 1) %>% setView(lat=-10, lng=-48, zoom=3)
})
...
renderPlotly({
  ...
  ylab("Casos Acumulados (em milhares)") + darktheme + theme(legend.position = "none") +
...
ggplotly(ggplot(data=covid_brasil, aes(x=data, y=casosAcumulado/1000)) +
    ...
    darktheme +
  ggtitle("") + xlab("") + ylab("Casos Acumulados (em milhares)") +
  scale_color_hue(l=40), tooltip = "text") %>% layout(hovermode = "x unified")
```
...
ggplotly(ggplot(data=covid_brasil, aes(x=data, y=100000*casosAcumulado/pop_2019)) +
  geom_line(size=1, color="darkgreen") + 
    geom_point(size=.8, color="darkgreen", aes(text=paste0(format(data, "%d %b %Y"),": ",format(round(100000*casosAcumulado/pop_2019,2), decimal.mark=",", big.mark=".",
                                          small.mark=".")))) + 
    darktheme +
  xlab("") + 
  ylab("Casos Confirmados (por 
  ...
  geom_line(size=1, color="darkred") + 
    geom_point(size=.8, color="darkred", 
               aes(text=paste0(format(data, "%d %b %Y"),": ", 
                               format(round(100000*obitosAcumulado/pop_2019,2), decimal.mark=",", big.mark=".", 
                                      small.mark=".")))) + 
    darktheme +
  xlab("") + 
  ylab("Óbitos (por 100
